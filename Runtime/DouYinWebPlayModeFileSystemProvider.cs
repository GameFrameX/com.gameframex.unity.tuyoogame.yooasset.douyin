...
{
    /// <summary>
    /// 抖音小游戏 Web 运行模式文件系统提供者
    /// </summary>
    [UnityEngine.Scripting.Preserve]
    internal sealed class DouYinWebPlayModeFileSystemProvider : IWebPlayModeFileSystemProvider
    {
        ...
        public FileSystemParameters CreateFileSystemParameters(WebPlayModeProviderContext context)
        {
            ...
            {
                return ByteGameFileSystemCreater.CreateByteGameFileSystemParameters();
            }

            return ByteGameFileSystemCreater.CreateByteGameFileSystemParameters(context.HostServerURL);
        }
        ...
        internal static class Registrar
        {
            ...
            {
                WebPlayModeFileSystemProviderRegistry.Register(new DouYinWebPlayModeFileSystemProvider());
            }
        }
    }
}
